            ...
            <div className=''>
                <div className='lg:flex border-b-[2px] border-[#fff6] m-8 pb-10'>
                    ...
                    <div className='flex items-start justify-evenly w-[20%] max-[1024px]:gap-3'>
                        <a href="#" className='p-3 rounded-full bg-[#292929] group hover:scale-105'><svg className='group-hover:fill-white' data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" height={16} width={16} fill="#b3b3b3">
                            <path
