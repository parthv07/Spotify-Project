...
import { Applebtn, Facebookbtn, Googlebtn, Input, Logbutton, Phonebtn, Termsandc } from "./small components/Components";
const Loginpage = () => {
    return (
        <div>
            <div className='p-8 bg-gradient-to-b from-[#2a2a2a] to-black flex justify-center items-center'>
                <div className='bg-[#121212] max-w-[734px] w-full rounded-lg flex flex-col items-center justify-center '>
                    <div className='w-[44.143%]'>
                        <div className='flex flex-col items-center justify-center gap-2 mt-8'>
                            ...
                            <h1 className='text-[32px] font-bold text-center text-[#fff] leading-tight mb-10'>Log in to Spotify</h1>
                        </div>
                        <div >
                            <Googlebtn />
                            <Facebookbtn />
