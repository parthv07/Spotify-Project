...
const Navbarphone = ({ handlequeue, setopensrch, showQueue }) => {
    return (
        <div className=''>
            <div className='bg-black w-full grid grid-cols-4 justify-center align-center pt-2.5 pb-2'>
                ...
                <div onClick={handlequeue} className='flex flex-col justify-between items-center'><HiOutlineQueueList className={` ${showQueue ? "stroke-white" : ""} h-6 w-6`} /> <span className={`text-sm ${showQueue ? "text-white" : ""}`} >Queue</span></div>
